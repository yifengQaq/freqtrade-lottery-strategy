...
class LotteryMindsetStrategy(IStrategy):
    ...
    leverage_value = 5
    macd_fast = IntParameter(8, 16, default=8, space="buy", optimize=True)
    macd_slow = IntParameter(20, 34, default=22, space="buy", optimize=True)
    macd_signal = IntParameter(5, 14, default=6, space="buy", optimize=True)
    rsi_period = IntParameter(7, 21, default=12, space="buy", optimize=True)
    ...
    atr_period = IntParameter(7, 21, default=10, space="buy", optimize=True)
    atr_ma_window = IntParameter(20, 100, default=30, space="buy", optimize=True)
    atr_multiplier = DecimalParameter(0.8, 2.0, default=1.2, decimals=1, space="buy", optimize=True)
    adx_period = IntParameter(7, 28, default=12, space="buy", optimize=True)
